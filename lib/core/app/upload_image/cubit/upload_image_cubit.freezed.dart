...
class __$$FailureStateImplCopyWithImpl<$Res>
    extends _$UploadImageStateCopyWithImpl<$Res, _$FailureStateImpl>
...
class _$FailureStateImpl implements FailureState {
  const _$FailureStateImpl({required this.errmessage});
  ...
  @override
  String toString() {
    return 'UploadImageState.failure(errmessage: $errmessage)';
  }
...
abstract class FailureState implements UploadImageState {
  const factory FailureState({required final String errmessage}) =
      _$FailureStateImpl;
